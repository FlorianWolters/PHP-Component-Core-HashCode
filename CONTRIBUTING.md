...
Contributions to **FlorianWolters\Component\Core\HashCode** are always welcome.
...
Run the following commands to initially checkout **FlorianWolters\Component\Core\HashCode**:
